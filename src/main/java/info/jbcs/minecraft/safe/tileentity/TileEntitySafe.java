package info.jbcs.minecraft.safe.tileentity;

import info.jbcs.minecraft.safe.inventory.InventoryStatic;
...
public class TileEntitySafe extends TileEntity implements IInventory, ISidedInventory {
	...
	public InventoryStatic inventory = new InventoryStatic(36) {
		@Override
