package info.jbcs.minecraft.safe.block;

import info.jbcs.minecraft.safe.GeneralSafeClient;
...
public class BlockSafe extends BlockContainer implements ITileEntityProvider {
	...
	public static void fallSound(World world, int x, int y, int z, int distance){
	...
	public void finishFall(World world, int x, int y, int z, int meta, NBTTagCompound tag, int distance){
		if(world.isRemote){
